...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_ytms0os', 'template_h1srmn9', form.current, '9KZ66FdXw69YDT_t7')
        .then((result) => {
    ...
    <div className="contact-form" id='Contact'>
        <div className="c-left">
            <div className="awesome">
                <span style = {{color: darkMode? 'white': ''}}>Get in Touch<br/><span>Contact me</span></span>
